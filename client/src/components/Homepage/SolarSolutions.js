...
const SolarSolutions = (props) => {
  ...
  const headerTextFontSize = selectTSML(
    w,
    "1rem",
    "1.5rem",
    "1.5rem",
  ...
  const headerPadding = selectTSML(
    w,
    "2rem 1.4rem 1rem 1.4rem",
    "1rem 0 0rem 2rem",
    "1rem 0 0rem 3rem",
    "1rem 0 0rem 3rem"
  );
  const blurbPadding = selectTSML(w, "0rem 1.4rem 3rem 1.4rem");
  const tileHeaderFontSize = selectTSML(w, "1.4rem");
          ...
          >
            {[
              ...
              <ProductTile
                ...
                headerStyles={{
                  fontSize: tileHeaderFontSize,
                  padding: headerTilePadding,
                }}
              />
            ))}
          </div>
